...
export const meta = {
  decsription: 'Building a responsive, performant and engaging react/redux app for Lords, the home of cricket.';
}

export default ({ children }) => (
  <Layout>
    <Head pageTitle="Projects, Lord's Matchday Scorecard" meta={meta} />
    <Breadcrumbs
      crumbs={[
        { title: "Home", url: "/" },
        { title: "Projects" },
